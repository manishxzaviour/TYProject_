...
// const int interuptPMy=0;
// const int interuptPu=0;
//
// set revs dir and delay using query
static esp_err_t motorRev(httpd_req_t *req)
{
    char *buf;
    size_t buf_len;
    char revs[32] = {
...
{
    ArduinoOTA.setHostname("Lara_cam_s");
    ArduinoOTA.onStart([]()
                       {
    String type;
